...
版本固定在提交号 `9b3d652e6753a1a93361a0a2207a2c21e81eb51e`，升级时替换文件内容并同步更新本行。
...
生成链在 `server/contracts/build.rs` 中把本目录作为 include 根，因此 Rust 侧不需要安装 `protoc`，也不需要 `googleapis` 的其余文件。
